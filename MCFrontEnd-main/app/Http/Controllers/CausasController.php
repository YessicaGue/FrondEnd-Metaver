...
class CausasController extends Controller
{
    public function index(): \Inertia\Response {
        ...
        return Inertia::render('Causas/index', [ "auth" => [ "user" => $user ] ]);
    }
    ...
    public function getCatalogos() {
        ...
        try {
            $request = $client->request('GET', env('API_BASE')."/api/registroCausa/get/catalogos");
    ...
    public function create(Request $request) {
        ...
        try {
            $body = [
                'json' => [
                    'data' => json_encode([
                        ...
                        'causaIds' => $decodedRequest->causaIds,
            ...
            $request = $client->request('POST', env('API_BASE')."/api/registroCausa", $body);
            $response = json_decode($request->getBody()->getContents());
