...
class MiCandidaturaController extends Controller
{
    public function mercadito(): \Inertia\Response {
        ...
        if (!is_null($perfilId) && $perfilId == 400) // JG - 20230828 - Salto de validaciones
            return Inertia::render('CaminoCandidato/MiCandidatura', [ // JG - 20230828 - Salto de validaciones
                'isDemo' => true, // JG - 20230828 - Salto de validaciones
                "auth" => [ "user" => $user ] //JJ 20230912
            ]); // JG - 20230828 - Salto de validaciones

        return Inertia::render('CaminoCandidato/MiCandidatura',
            [
                "auth" => [ "user" => $user ] //JJ 20230912
            ]);
    }
