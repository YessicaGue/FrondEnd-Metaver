...
import './style.css';
import carta from './CartasDeBienvenidaCaminos/CartaCaminoBlanco.pdf';
import Swal from "sweetalert2";

function CaminoBlanco(props) {
    const {
        isDemo = false,
        auth: { user }
    } = props;
    const [camino,setCamino] = useState(4);
        ...
        <div className='grid gap-10 grid-cols-2 mt-20 max-lg:grid-cols-1 w-full'>
                ...
                <div className="w-full min-h-[600px] mt-2 relative">
                    <div className='w-full h-full'>
                        {/* <iframe className='min-h-[80px] sm:min-h-[80px] md:min-h-[700px] lg:min-h-[700px] xl:max-h-[1100px]' src="https://player.vimeo.com/video/852792347?h=e05b4514d1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" allowFullScreen width='100%' height='100%'></iframe> */}
                        <iframe src="https://player.vimeo.com/video/852792347?h=e05b4514d1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" className='h-full w-full' allow="autoplay; fullscreen; picture-in-picture" title="Poncho Vidales - Camino Blanco"></iframe>
                    </div>
                </div>
