        ...
        <section className='grid lg:grid-cols-3 sm:grid-cols-1 pb-20' style={{ fontFamily: 'Montserrat', letterSpacing: '2px', fontweigh:'500' }}>
            <div className='col-span-2 my-10 mb-20 lg:max-w-6xl md:max-w-5xl m-auto w-full h-full'>
                    <div className='lg:max-w-6xl md:max-w-5xl m-auto w-full h-full my-10 my-10 pl-10'>
                        <iframe className='min-h-[400px] sm:min-h-[300px] md:min-h-[400px]' src="https://player.vimeo.com/video/854532900?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowFullScreen width='100%' height='100%'></iframe>
                    </div>

                </div>

                <div className='flex flex-col gap-4 pt-20 px-10 sm:ml-10 mt-10 justify-center'>
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500' }}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=29' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                    ...
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500' }}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=27' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                                    props['usuario']['username'],
                    ...
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500' }}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=28' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                                    props['usuario']['username'],
                    ...
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500' }}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=26' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                                    props['usuario']['username'],
                            ...
                            >
                            Uso del Centro de Inteligencia
                        </a>
                    </button>
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500'}}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=23' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                                    props['usuario']['username'],
                    ...
                    <button className='bg-gradient-to-r from-red-600 to-orange-400 rounded-lg py-2 text-white shadow-xl font-bold opacity-80 hover:opacity-100 transition-all' style={{ fontFamily: 'Montserrat', fontweigh:'500' }}>
                        <a className='w-full h-full'href='https://capacitacion.ciudadanosenmovimiento.org/course/view.php?id=24' target='_blank' rel='noopener noreferrer'
                            onClick={() => {
                                LoginMoodle(
                                    props['usuario']['name'],
                                    props['usuario']['username'],
            ...
            <div className='w-full flex justify-start gap-6 ml-10'>
                ...
                <button className='bg-gradient-to-r from-red-600 to-orange-400 text-white text-xl rounded-xl font-bold px-6 py-3 mt-10 flex justify-center mb-10' onClick={() => { location.replace(route('crea.equipo.page')) }}>
