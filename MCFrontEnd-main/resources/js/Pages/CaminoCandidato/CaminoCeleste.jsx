...
import './style.css';
import carta from './CartasDeBienvenidaCaminos/CartaCaminoCeleste.pdf';
import Swal from "sweetalert2";

function CaminoCeleste(props) {
    const {
        isDemo = false,
        auth: { user }
    } = props;
    const [camino,setCamino] = useState(6);
  ...
  return (
    <CustomLayout user={ user } visible={ true } >
        ...
        <body className='max-w-10xl mx-auto px-2 xs:px-6 sm:px-10 lg:px-10 pt-[calc(25px+2vw+2vh)] pb-[calc(25px+5vw+5vh)]'>
            ...
            <div className='grid gap-5 grid-cols-2 mt-20 max-lg:grid-cols-1 w-full'>
                ...
                <div className="w-full min-h-[500px] bg-white mt-2 relative">
                    <div className='w-full h-full'>
                    <iframe className='min-h-[80px] sm:min-h-[80px] md:min-h-[700px] lg:min-h-[700px] xl:max-h-[1100px]' src="https://player.vimeo.com/video/853588989?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" allowFullScreen width='100%' height='100%'></iframe><script src="https://player.vimeo.com/api/player.js"></script>
                    </div>
                </div>
