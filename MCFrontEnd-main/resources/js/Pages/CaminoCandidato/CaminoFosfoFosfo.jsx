...
import './style.css';
import carta from './CartasDeBienvenidaCaminos/CartaCaminoFosfo.pdf';
import Swal from "sweetalert2";

function CaminoFosfoFosfo(props) {
    const {
        isDemo = false,
        auth: { user }
    } = props;
    const [camino,setCamino] = useState(3);
        ...
        <div className='grid gap-10 grid-cols-2 mt-20 max-lg:grid-cols-1 w-full'>
                ...
                <div className="w-full min-h-[700px] mt-2 relative">
                    <div className='w-full h-full'>
                        <iframe className='min-h-[80px] sm:min-h-[80px] md:min-h-[700px] lg:min-h-[700px] xl:max-h-[1100px]' src="https://player.vimeo.com/video/853587150?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" allowFullScreen width='100%' height='100%'></iframe><script src="https://player.vimeo.com/api/player.js"></script>
                    </div>
                </div>
...
export default CaminoFosfoFosfo;
