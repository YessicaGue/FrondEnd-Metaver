...
export function RegisterContent() {
    ...
    const submit = (e) => {
        ...
        post(route('crear.registro.perfil', { acceso: 'camino-heroe-ciudadano' }));
    };
        ...
        <GuestLayout chc={ true }>
            ...
            <form onSubmit={submit} className='relative'>
                ...
                <div className="mt-6 mb-6">
                    ...
                    >
                        <div className={ `shadow-sm border ${ isReCaptchaCompleted ? 'border-mc-primary bg-mc-primary' : 'border-gray-300' } rounded-md w-16 h-10 transition-all` }>
                            {
                ...
                <div className="flex items-center justify-end mt-4 gap-4 flex-col-reverse">
                    <a
                        ...
                        className="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex gap-2"
                    >
                        Soporte
