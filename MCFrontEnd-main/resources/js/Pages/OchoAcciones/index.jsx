...
import FormularioOchoAcciones from '@/Pages/OchoAcciones/FormularioOchoAcciones';
...
const index = (props) => {
    ...
    return (
        <CustomLayout user={ user }>
            <Head title="Regístrate en ocho acciones" />
                    ...
                    <TrailAppear>
                        <Box className='max-md:w-full w-3/4'>
                            <Typography variant='h3' fontWeight='800' className='text-white font-black max-md:text-center' style={{
                                ...
                                Bienvenid@ al formulario para registrarse en ocho acciones
                            </Typography>
                        </Box>
