...
import { useFormCausas } from './Hooks/useFormCausas';
import { StepperWindow } from './StepperWindow';
import { Container } from '@mui/material';

const FormularioCausa = () => {
    const { set, icons, handleSubmit, setForm, form } = useFormCausas();
...
export default FormularioCausa;