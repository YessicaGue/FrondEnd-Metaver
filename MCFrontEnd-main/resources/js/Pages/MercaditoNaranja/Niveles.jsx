...
const AsideMenu = () => (
    <aside className='w-full h-full bg-stone-100 p-4'>
                    ...
                    <ul className='w-full mt-4'>
                        ...
                        <li className=' hover:border-mc-primary border-4 border-solid border-transparent  rounded-lg py-2 px-4'><a href={'../mercadito-naranja-nivel' }>Ver productos de nivel</a></li>
